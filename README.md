# Overview
This is the React-based frontend for the supervisor application. It contains all the components for the front-end app. 
...
# Running with docker
To run this application you need to use docker.
Installation steps for docker can be found on their main page.
https://docs.docker.com/engine/install/

With Docker installed, you can build your new image.
```
